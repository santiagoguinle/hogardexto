...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input name="person[has_occupation]" class="bootstrap-switch" id="has_occupation" type="checkbox" data-on-text="Si" value="1" data-off-text="No" data-off="danger" <?= ($person["has_occupation"]=="1") ? 'checked="checked"' : "" ?>>
    </div>
</div>
